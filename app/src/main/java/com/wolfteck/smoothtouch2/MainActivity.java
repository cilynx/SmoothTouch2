        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                if(positionOffsetPixels == 0) {
                    if (mSectionsPagerAdapter.getItem(position).getView().findViewById(R.id.dro_x) != null) {
                        Interface.getInstance(getApplicationContext()).startDRO(new TextView[]{
                                (TextView) mSectionsPagerAdapter.getItem(position).getView().findViewById(R.id.dro_x),
                                (TextView) mSectionsPagerAdapter.getItem(position).getView().findViewById(R.id.dro_y),
                                (TextView) mSectionsPagerAdapter.getItem(position).getView().findViewById(R.id.dro_z)
                        });
                    }
                }
            }
